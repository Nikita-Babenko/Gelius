...
(
  PRODUCTS_TYPE_ID BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
(
  RAW_MANUFACTURER_ID BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  RAW_MANUFACTURER VARCHAR(50)
);
ALTER TABLE products ADD FOREIGN KEY (CLIENTS_ID) REFERENCES clients (CLIENTS_ID);
ALTER TABLE products ADD FOREIGN KEY (PRODUCTS_TYPE) REFERENCES product_type (PRODUCTS_TYPE_ID);
ALTER TABLE products ADD FOREIGN KEY (CARDBOARD_BRAND) REFERENCES cardboard_brand (CARDBOARD_BRAND_ID);
ALTER TABLE products ADD FOREIGN KEY (PROFILE) REFERENCES profile (PROFILE_ID);
