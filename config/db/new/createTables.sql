...
CREATE TABLE product(
  ...
  FOREIGN KEY (cardboard_brand) REFERENCES cardboard_brand(cardboard_brand_id),
  FOREIGN KEY (cellulose_layer) REFERENCES cellulose_layer(cellulose_layer_id),
  FOREIGN KEY (face_layer) REFERENCES face_layer(face_layer_id),
  FOREIGN KEY (inner_layer) REFERENCES inner_layer(inner_layer_id),
  FOREIGN KEY (connection_valve) REFERENCES connection_valve(connection_valve_id),
  FOREIGN KEY (packing) REFERENCES packing(packing_id),
  FOREIGN KEY (pallet) REFERENCES pallet(pallet_id),
  FOREIGN KEY (pallet_placement) REFERENCES pallet_placement(pallet_placement_id)
);
