...
@Entity
@Table(name = "perforation_deltas")
public class PerforationDeltas {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "perforation_deltas_id")
    private Long id;
    ...
    @Column(name = "delta_4", precision = 5, scale = 3)
    private Double delta4;

    public PerforationDeltas() {
    }
    ...
    public boolean equals(Object o) {
        ...
        PerforationDeltas that = (PerforationDeltas) o;
